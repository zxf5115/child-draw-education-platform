        ...
        <el-card class="box-card" shadow="never">
          ...
          <div class="text item">
            <el-form ref="form" :model="dataForm" label-width="80">
              ...
              <el-row>
                <el-col :span="6">
                  <el-form-item :label="$t('squad.title')" label-width="100">
                    <span v-if="dataForm.squad && dataForm.squad[0]">
                      {{ dataForm.squad[0].title }}
                    </span>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  <el-form-item :label="$t('squad.squad_no')" label-width="100">
                    <span v-if="dataForm.squad && dataForm.squad[0]">
                      {{ dataForm.squad[0].squad_no }}
                    </span>
                  </el-form-item>
                </el-col>
              </el-row>
        ...
        <el-card class="box-card mt10" shadow="never">
          ...
          <div class="text item">
            <el-table :data="dataForm.course" v-loading="dataListLoading" height="300">
              ...
              <el-table-column :label="$t('member.archive.open_squad_period')" width="150">
                <template slot-scope="scope" v-if="scope.row.pivot">
                  否
                </template>
              </el-table-column>

              <el-table-column :label="$t('member.archive.money')" width="150">
                <template slot-scope="scope" v-if="scope.row.pivot">
                  123
                </template>
              </el-table-column>
