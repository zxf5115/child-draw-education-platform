        ...
        <div class="admin_main_block">
            <div class="admin_main_block_top">
                <div class="admin_main_block_left">
                    <!-- <div><router-link to="/roles/form"><el-button type="primary" icon="el-icon-plus">添加</el-button></router-link></div> -->
            ...
            <div class="admin_table_main">
                <el-table :data="list" @selection-change="handleSelectionChange" >
                    ...
                    <el-table-column prop="id" :label="$t('common.id')" fixed="left" width="70px"></el-table-column>
                    ...
                    <!-- <el-table-column label="操作" fixed="right" width="120px">
                        <template slot-scope="scope">
                            <el-button icon="el-icon-edit" @click="$router.push({name:'roles_form',query:{id:scope.row.id}})">编辑</el-button>
...
<style lang="scss" scoped>
  ...
  .admin_form_main >>> .form-input-item {
    width: 400px;
    float: left;
  }
  .admin_form_main >>> .form-input-description {
    width: 60%;
    float: left;
    color: red;
    margin-left: 20px;
