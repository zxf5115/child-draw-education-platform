          ...
          <el-col :span="24">
            <el-form-item :label="$t('course.resource.url')" prop="url">
              <el-upload class="upload-demo"
                :action="this.$http.adornUrl('/file/picture')"
          ...
          <el-col :span="24">
            <el-form-item :label="$t('course.point.question.answer')" prop="answer">
              <el-radio-group v-model="dataForm.answer">
                <el-radio v-for="(option) in dataForm.options" :label="option.title" :key="option.title">
                  {{ option.title }}
                </el-radio>
              </el-radio-group>
            </el-form-item>
    ...
    methods: {
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/${this.model}/choices`),
              method: 'post',
