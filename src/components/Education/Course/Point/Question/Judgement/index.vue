              ...
              <el-row :gutter="5">
                ...
                <el-col :span="19">
                  <el-row :gutter="5">
                    ...
                    <el-col :span="6">
                      <el-radio-group v-model="option.answer">
                        <el-radio :label="1">
                          {{ $t('course.point.question.correct') }}
                        </el-radio>
                        <el-radio :label="2">
                          {{ $t('course.point.question.error') }}
                        </el-radio>
                      </el-radio-group>
                    </el-col>
                    <el-col :span="1">
    ...
    methods: {
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/${this.model}/judgement`),
              method: 'post',
      ...
      addOption () {
        ...
        if (this.dataForm.options.length > 0) {
          ...
          this.dataForm.options.push({ title: '', value: '', answer: '' })
        } else {
          this.dataForm.options.push({ title: '', value: '', answer: '' })
        }
      },
