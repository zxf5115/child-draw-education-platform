<template>
  <el-form label-width="100px" ref="dataForm" :model="dataForm" :rules="dataRule">
    ...
    <el-form-item :label="$t('course.course_unit')" prop="unit_id">
      <el-cascader :key="isResouceShow" v-model="dataForm.unit_id" :placeholder="$t('common.please_select')+$t('course.course_unit')" :show-all-levels="false" :options="level" :props="levelProps" clearable></el-cascader>
    </el-form-item>
